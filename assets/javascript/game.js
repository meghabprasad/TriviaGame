window.onload = function() { 
    ...
    $(document).on("click", ".btn", function(){ 
        console.log("Before: ", questionAnswered)
        if (!questionAnswered && $(this).attr("data-correct") === "t"){
                questionAnswered = true;
                console.log("After: ", questionAnswered)
            ...
            else if (!questionAnswered && $(this).attr("data-correct") === "f"){
                questionAnswered = true;
                console.log("After: ", questionAnswered)
